...
{
    [ResourceType("MappingInfo.json")]
    public class MappingInfoExcel : ExcelBase
    {
        public uint ID { get; set; }
        public uint WorldLevel { get; set; }

        [JsonConverter(typeof(JsonStringEnumConverter))] // 使用 JsonStringEnumConverter
        public FarmTypeEnum FarmType { get; set; } = FarmTypeEnum.None; // None
        ...
        public override void OnLoad()
        {
            ...
            List<uint> equipDrop = [];
            Dictionary<uint, List<uint>> relicDrop = [];
            ...
            foreach (var item in DisplayItemList)
            {
                ...
                if (item.ItemID == 2)
                {
                    ...
                    {
                        ItemID = 2,
                        MinCount = (50 + WorldLevel * 10) * (uint)FarmType,
                        MaxCount = (100 + WorldLevel * 10) * (uint)FarmType
                    });
                ...
                else if (excel.ItemMainType == ItemMainTypeEnum.Material)
                {
                    ...
                    switch (excel.PurposeType)
                    {
                        ...
                        case 1:
                            ...
                            drop = new MappingInfoItem(excel.ID, (uint)amount);
                            break;
                        // Boss materials
                        case 2:
                        ...
                        case 4:
                            drop = new MappingInfoItem(excel.ID, (uint)(WorldLevel * 0.5 + 0.5));
                            break;
                        ...
                        case 5:
                            ...
                            drop = new MappingInfoItem(excel.ID, (uint)count);
                            break;
                        // Lucent afterglow
                        case 11:
    ...
    public class MappingInfoItem
    {
        ...
        public MappingInfoItem(uint itemId, uint itemNum)
        {
            ItemID = itemId;
            ItemNum = itemNum;
        }
